      ...
      <CardContent className="p-6">
        <div className="flex items-center mb-4">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-gray-text">{tripDuration} days</p>
          </div>
        </div>
        ...
        <div className="flex items-center mb-4">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-gray-text">{activitiesCount} planned</p>
          </div>
        </div>
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-gray-text">{accommodationsCount} booked</p>
          </div>
        </div>
